          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <button
                ...
                className={`w-full bg-emerald-600 text-white py-2 px-4 rounded-md hover:bg-emerald-800 transition-colors ${
                  mutation.isPending ? "opacity-100 cursor-not-allowed" : ""
                }`}
              >
